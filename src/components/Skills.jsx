  ...
  <section className="min-h-fit bg-bg_light_primary" id="skills">
    {/* <Modal isOpen={modalIsOpen} onRequestClose={closeModal} style={customStyles}> */}
      ...
      {/* <ul className="list-decimal px-4 font-Poppins sm:text-sm text-xs !leading-7">
        <li>Proficient in Core Java, with a strong understanding of object-oriented programming, data types, and exception handling. </li>
     ...
     <div className="flex flex-wrap gap-4 justify-center">
      {skills.skills_content.map((skill, i)=>(
         ...
         className="bg-white sm:cursor-pointer relative group w-full flex items-center gap-5 p-5 max-w-sm rounded-md border-2 border-slate-200">
          <div>
            <img src={skill.logo} 
            alt="..." className="w-10 group-hover:scale-125 duration-200"/>
          </div>
          <div>
            <h6>{skill.name}</h6>
